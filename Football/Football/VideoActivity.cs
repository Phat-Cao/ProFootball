...
namespace Football
{
    [Activity(Label = "VideoActivity", Theme = "@style/Theme.AppCompat.Light.NoActionBar")]
    public class VideoActivity : AppCompatActivity
    {
        ...
        private const string RSS_link = "http://bongda24h.vn/RSS/201.rss";
        ...
        {
            VideoActivity vdActivity;
            ProgressDialog mDialog;

            public LoadDataASync(VideoActivity vdActivity)
            {
                this.vdActivity = vdActivity;
            }

            protected override void OnPreExecute()
            {
                mDialog = new ProgressDialog(vdActivity);
            ...
            protected override void OnPostExecute(string result)
            {
                ...
                mDialog.Dismiss();
                FeedAdapter adapter = new FeedAdapter(data, vdActivity);
                vdActivity.recyclerView.SetAdapter(adapter);
