...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AppIntro.PagerAdapter, AppIntro, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", PagerAdapter.class, __md_methods);
	}


	public PagerAdapter (android.support.v4.app.FragmentManager p0) throws java.lang.Throwable
	{
		super (p0);
		if (getClass () == PagerAdapter.class)
			mono.android.TypeManager.Activate ("AppIntro.PagerAdapter, AppIntro, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Support.V4.App.FragmentManager, Xamarin.Android.Support.Fragment, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", this, new java.lang.Object[] { p0 });
	}
