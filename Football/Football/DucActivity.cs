...
namespace Football
{
    [Activity(Label = "Bóng đá Đức")]
    public class DucActivity : FragmentActivity
    {
        RecyclerView recyclerView, recyclerView1;
        RssObject rssObject;
        RecyclerView.LayoutManager layoutManager;
        DucCLB ducCLB;
        DucCLBAdapter clbAdapter;

        private const string RSS_link = "http://bongda24h.vn/RSS/193.rss";
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            ducCLB = new DucCLB();
            SetContentView(Resource.Layout.DucActivity);
            ...
            adapter.AddFragmentView((i, v, b) => {
                ...
                clbAdapter = new DucCLBAdapter(ducCLB);
        ...
        {
            DucActivity ducActivity;
            ProgressDialog mDialog;

            public LoadDataASync(DucActivity ducActivity)
            {
                this.ducActivity = ducActivity;
            }

            protected override void OnPreExecute()
            {
                mDialog = new ProgressDialog(ducActivity);
            ...
            protected override void OnPostExecute(string result)
            {
                ...
                mDialog.Dismiss();
                FeedAdapter adapter = new FeedAdapter(data, ducActivity);
                ducActivity.recyclerView.SetAdapter(adapter);
